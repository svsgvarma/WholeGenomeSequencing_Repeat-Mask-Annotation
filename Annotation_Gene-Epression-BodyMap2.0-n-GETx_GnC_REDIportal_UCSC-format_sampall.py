...
python Annotation_Gene-Epression-BodyMap2.0-n-GETx_GnC_REDIportal_UCSC-format_sampall.py ADCA_009-028-080_chr1-MT_Variants_Het_PASS_MAF5%_CRLD_RE-RG-LDB.txt ADCA_009-028-080_chr1-MT_Variants_Het_PASS_MAF5%_CRLD_RE-RG-LDB_GExp_GnC_REDIportal_UCSC.txt /media/varma/Maxtor/ADCA_WGS_ANNOTATION_ANNOVAR/ 3
...
clF0 = SearchDB().VariantCount_onGenes(sys.argv[1],sys.argv[3],sys.argv[4])
clF1 = SearchDB().Human_BodyMap20(sys.argv[3],sys.argv[4])
clF2 = SearchDB().GeneExp_GETx(sys.argv[3],sys.argv[4])
clF3 = SearchDB().REDIportal_add(sys.argv[3],sys.argv[4])
clF3 = SearchDB().UCSC_add(sys.argv[2],sys.argv[3],sys.argv[4])
