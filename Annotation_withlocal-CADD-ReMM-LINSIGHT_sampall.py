...
#./Annotation_withlocal-CADD-ReMM-LINSIGHT_sampall.py ADCA_009-028-080_chr1-MT_Variants_Het_PASS_MAF5%_head.txt ADCA_009-028-080_chr1-MT_Variants_Het_PASS_MAF5%_CRLD_head.txt /media/varma/Maxtor/ADCA_WGS_ANNOTATION_ANNOVAR/
...
clF1 = SearchDB().Search_CADD(sys.argv[1],sys.argv[3])
clF2 = SearchDB().Search_ReMM(sys.argv[3])
clF3 = SearchDB().Search_LINSIGHT(sys.argv[3])
clF3 = SearchDB().Search_DANN(sys.argv[2],sys.argv[3])
